...
def hero():
    ...
    while(y):
        clear()
        system(banner)
        print("Contact me on instagram @Vijith_777")
        ...
        if (len(numbers)>11):
            ...
            sys.exit(" \n \n \n Contact on Instagram @vijith_777")
            #print(numbers)
...
if(expirydate>today):
    ...
    if (now>Third and now<Thirdend):
        ...
        print(" admin on Instagram @VIJITH_777 ")
    ...
    print(" on Instagram ----@vijith_777 for activating")
    ...
    while(True):
        print("My banking name is V7JITH")
        print("If you send to any other name , then IT IS SCAMMM")
        print("--------*--------*----------*---------")
        print("send payment only to H4Cker_V7JITH ")
        print("payhere--- UPI : ")
        print("Itz Full Free")
        print("MAKE YOU MILLIONAIRE")
        print("If you have already paid Your West Of earth")
        ...
        if(bhai==code or bhai==test):
            clear()
            print("----------Your play time-----------")
            print("6th Dec 2022, 02:30 PM- 03:00 PM")
            print("6th Dec 2022, 05:30 PM- 06:00 PM")
            print("6th Dec 2022, 08:30 PM- 09:00 PM")
            print("Please play on the given time, and ")
            print("If you think it is an error contact")
            print("wait.... starting....")
            time.sleep(20)
            ...
            system(banner)
            print("----------Your play time-----------")
            #print("8th-14th Nov 2022, 02:30 PM- 03:00 PM")
            #print("8th-14th Nov 2022, 06:00 PM- 06:30 PM")
            #print("8th-14th Nov 2022, 08:30 PM- 09:00 PM")
            #print("Please play on the given time, and ")
            #print("If you think it is an error contact")
            #print("wait.... starting....")
            time.sleep(20)
